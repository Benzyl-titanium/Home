...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/blog2.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "合成实验",
			url: "https://chemhandbook.netlify.app", // Internal links should not include the base path, as it is automatically added
